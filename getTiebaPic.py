...
class tieba(object):
    ...
    def saveImg(self,z):
        ...
        for i in images:
            ...
            # fname = p1 + "//" + fname + fextention[1]
            fname = "D://Studying//Python//TiebaPic//images//" + fname + fextention[1]
...
class catchLinks(Thread):
    ...
    def __init__(self):
        ...
        self.url = "http://tieba.baidu.com/f?ie=utf-8&kw=k&tp=0&pn="
...
class catchImages(Thread):
    ...
    def run(self):
        ...
        l = t.saveImg(y)
        t.getAll()
        print "get topic %s ok" % self.url
        print "--get %d images in this topic" % l
        sys.stdout.flush()
